    ...
    <div id="content">
      ...
      <div id="challenge"></div>
        ...
        <section class="bg-nuages test">
            <div class="container ">
                <h1>Le Challenge</h1>
                <p>Le Challenge ENAC Alumni – Avico est un concours de création d’entreprise dans le domaine aéronautique. Il est porté par ENAC Alumni avec le soutien d’Avico, son partenaire fondateur.</p>

                <p>La 1ère édition du Challenge fut lancée en 2014, et devant le succès du Challenge et la qualité des projets reçus, les organisateurs ont décidé de lancer une 2nde édition du Challenge ENAC Alumni Avico en 2015. L’objectif commun d’ENAC Alumni et d’Avico est de récompenser les meilleurs projets innovants chaque année, de devenir un véritable laboratoire d’idées connu et reconnu.</p>

                <p>Nous souhaitons faire émerger des idées novatrices dans le domaine de l’aéronautique et stimuler la fibre entrepreneuriale chez les jeunes, moins jeunes, expérimentés ou néophytes qui se lanceraient dans l’aventure du Challenge.</p>

                <p>Le Challenge ENAC Alumni Avico est ouvert à tous à partir de 18 ans, sans distinction de formation, de parcours, ou de nationalité. Les Challengers peuvent se présenter seuls ou par équipe. Le jury aura à cœur de sélectionner et promouvoir le meilleur projet, les dossiers présentés par des anciens élèves de l’ENAC ne feront l’objet d’aucune préférence.</p>
        ...
        <section class="color">
            <div class="container">
                ...
                <div class="row">
                	<div class="col-xs-2"><img src="img/patrickbaudis.jpg" alt="jury1"></div>
                	<div class="col-xs-2"><img src="img/patrickbaudis.jpg" alt="jury1"></div>
                    <div class="col-xs-2"><img src="img/patrickbaudis.jpg" alt="jury1"></div>
                    <div class="col-xs-2"><img src="img/patrickbaudis.jpg" alt="jury1"></div>
                	<div class="col-xs-2"><img src="img/patrickbaudis.jpg" alt="jury1"></div>
