<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container3">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.php#">Challenge Enac-Alumni Avico</a>
        </div>
        <div style="" aria-expanded="false" id="navbar" class="navbar-collapse collapse in">
          <ul class="nav navbar-nav">
            ...
            <li><button type="button" class="btncontact" data-toggle="modal" data-target="#mycontact"><a href="#ancrecontact" id="contact">Contact</a></button></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    </nav>